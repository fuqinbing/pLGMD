% /*********************************************************
%  ** function varargout = confidencePlot(varargin)
%  ** The horizontal axis should be time steps,
%  ** Plot a region in grey, which is the subtraction 
%  ** between the two average-led, standard deviation-restricted curve (upper and bottom boundaries).

%  * AUTHOR:  
%  *    1) Creator : Michele Giugliano
%  *    2) Amender : Mu 'sauceFlavoured256' HUA

%  * INPUT:  
%  *    1) X: one matrix containing the averages that can be plotted as a curve.
%  *    2) y: standard deviation corresponding to each average.
%  *    3) z: can be left empty.
%  *    4) 
...
%  * HISTORY:  
%  *    2002MMDD HHMM Scripted.
%  *    2017MMDD HHMM Amended.
%  *    20211123 1536 More comments added by Mu HUA
%  *    20220223 1616 General maintenance by Mu Hua
